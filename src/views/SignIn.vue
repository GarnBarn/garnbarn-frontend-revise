    ...
    <md-card class="signInCard">
      <md-card-media-actions>
        ...
        <md-card-actions>
          ...
          <div>
            <md-button class="md-dense md-raised" @click="oidcLogin"
              >Signin with OIDC Provider</md-button
            >
          </div>
...
<script lang="ts">
  ...
  export default class SignIn extends Vue {
    ...
    oidcLogin(): void {
      var provider = new firebase.auth.OAuthProvider("oidc.auth0");
      provider.addScope("read:garnbarn");
